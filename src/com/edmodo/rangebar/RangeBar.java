...
/**
 * The RangeBar is a double-sided version of a {@link android.widget.SeekBar} with discrete values. Whereas the thumb for the SeekBar can be dragged
 * to any position in the bar, the RangeBar only allows its thumbs to be dragged to discrete positions (denoted by tick marks) in the bar. When
...
public class RangeBar extends View {
	...
	/**
	 * Does all the functions of the constructor for RangeBar. Called by both RangeBar constructors in lieu of copying the code for each constructor.
	 * 
	 * @param context
	...
	/**
	 * A callback that notifies clients when the RangeBar has changed. The listener will only be called when either thumb's index has changed - not
